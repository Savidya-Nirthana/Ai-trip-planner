import os
from src.infrastructure.utils.place_info_search import GooglePlaceSearchTool, TavilyPlaceSearchTool
...
class PlaceSearchTool:
    ...
    def _setup_tools(self) -> List:
        ...
        def search_attractions(place:str)-> str:
            ...
            try:
                ...
                if attraction_result:
                    return f"Following are the attractions of {place} as suggested by google: {attraction_results}"
            except Exception as e:
                tavily_result = self.tavily_search.tavily_search_attractions(place)
                return f"Google cannot find the details due to {e}. \nFollowing are the restuarants of {place}: {tavily_result}" 

        @tool
        def search_restuarants(place: str) -> str:
            """Search restuarants of a place"""
            try:
        ...
        return [search_attractions, search_restuarants, search_activities, search_transportation]
