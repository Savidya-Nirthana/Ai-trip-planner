from src.infrastructure.utils.calculator import Calculator
...
class CalculatorTool():
    ...
    def _setup_tools(self) -> List:
        """ Setup all tools for the calculator tools"""
        @tool
        ...
        def calculate_total_expense(costs: List[float]) -> float:
            """Calculate total expense of the trip by summing a list of individual costs"""
